  ...
  return (
    <div className="text-center content-center pt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-5 md:pt-32 md:gap-8 justify-center">
        ...
        <div>
          <h3 className="hidden md:block md:font-bold md:text-2xl md:pr-96 text-left">At your fingertips</h3>
          <h1 className="hidden md:block md:pt-4 md:text-7xl md:pr-44 text-left">Lightning-fast <br />prototyping</h1>
          <h3 className="md:block font-bold text-base md:text-2xl md:pt-12 md:pr-52 text-left">Subscribe to our Newsletter</h3>
          <h3 className="md:block text-base md:text-2xl md:pt-3 pt-2 md:pr-44 text-left">Available exclusively on Figmaland</h3>
